    ...
    <div>
      ...
      <TracingBeam >
        ...
        <div className="h-[100vh] flex items-center top-0">
          <div className="basis-1/2 h-[100vh] rounded-3xl p-20 overflow-hidden"><SparklesDemo text="Pookie for bookies" /></div>

          <div className="basis-1/2 flex flex-col items-center">
            <AnimatedPinDemo />
            <Link href={'/dashboard'}><AuroraButtonDemo text="Pookie for books" css={'mx-5vh'} /></Link>
          </div>

        </div>

        <div className="flex w-80vw justify-center h-[100vh] gap-24 items-center">
          <FlipWordsDemo css="text-6xl" text1="The" words={['best', 'fastest', 'perfect']} text2="Translate model for books" />
          <EvervaultCardDemo text="Sci-fi" img="/book5.png" />
          <EvervaultCardDemo text="Romance" img="/book10.png" />
          <EvervaultCardDemo text="History" img="/book9.png" />
        </div>
        ...
        <Accordion type="single" collapsible className="w-2/3 mx-auto my-[20vh]">
...
import { AuroraButtonDemo } from "@/components/aurora-button";
